...
import { FiBookOpen, FiCompass, FiHome } from 'react-icons/fi';
      ...
      <aside className="hidden md:flex fixed left-0 top-0 h-screen z-40 bg-background border-r border-primary/15 flex-col w-[260px]">
        ...
        <div className="flex-1 overflow-y-auto p-4">
          <div className="space-y-2">
            <button
              type="button"
              className="w-full flex items-center gap-3 rounded-xl px-3 py-3 text-primary hover:bg-primary/5 transition-colors"
            >
              <FiHome size={18} />
              <span className="text-[15px] leading-none font-medium">Home</span>
            </button>
            ...
            >
              <FiCompass size={18} />
              <span className="text-[15px] leading-none font-medium">Meera</span>
            </button>

            <button
              type="button"
              className="w-full flex items-center gap-3 rounded-xl px-3 py-3 text-primary bg-primary/10 transition-colors"
            >
              <FiBookOpen size={18} />
              <span className="text-[15px] leading-none font-medium">My Library</span>
            </button>
          </div>
        </div>
