...
function SignInClient() {
  ...
  return (
    <main className="h-[100dvh] box-border flex flex-col px-2 pt-[calc(env(safe-area-inset-top)+0.5rem)] pb-2 md:px-4 md:pt-4 md:pb-4 lg:px-0 max-w-[450px] mx-auto w-full overflow-hidden">
